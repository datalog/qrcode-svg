/**
	...
	# (2020.02.20)
	+ QRCode Constructor became friendly
	+ QRCode.prototype.svg function was dramatically revamped by constantine

	Library was respectfully forked from:
...
function QRCode( options ) {
	...
	if( 0 === this.options.msg.length ) { /* || 7089 < this.options.content.length */
	...
	function _getUTF8Length( msg ) {
		...
		var
		res = encodeURI( msg ).toString().replace(/\%[0-9a-fA-F]{2}/g, 'a');
